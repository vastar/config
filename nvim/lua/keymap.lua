...
vim.keymap.set("n", "gS", ":SplitjoinToggle<CR>", { desc = "Split join toggle" })

vim.keymap.set("n", "<leader>?", ":WhichKey<CR>", { desc = "Buffer keymaps (which-key)" })

vim.keymap.set("n", "<Leader>xx", ":Trouble diagnostics<CR>", { desc = "Diagnostics (Trouble)" })
vim.keymap.set("n", "<Leader>xX", ":Trouble diagnostics filter.buf=0<CR>", { desc = "Buffer Diagnostics (Trouble)" })
...
vim.keymap.set("n", "<Leader>re", ":Telescope rest select_env<CR>", { desc = "Select REST environment" })
vim.keymap.set("n", "<Leader>rr", ":Rest run<CR>", { desc = "Run request under the cursor" })

vim.keymap.set("n", "<leader>dq", ":DapTerminate<CR>", { desc = "Terminate" })
...
vim.keymap.set("n", "<leader>dr", ":DapToggleRepl<CR>", { desc = "Toggle DAP REPL" })
